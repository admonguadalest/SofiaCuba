...
@UiController("test1_NotificacionGenerica")
@UiDescriptor("notificacion-generica.xml")
public class NotificacionGenerica extends Screen {
    ...
    private void onLkpPlantillaValueChange(HasValue.ValueChangeEvent<Plantilla> event) {
        ...
        //si es lista vacia devolver
        if (l.size()==1){
            if (l.get(0).toString().compareTo("")==0){
                return;
            }
        }
